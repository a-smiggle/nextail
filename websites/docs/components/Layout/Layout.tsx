...
import { LayoutV2 } from '@nextail/core/Layout';
...
function Layout(props: CustomProps): ReactElement {
    ...
    <LayoutV2
      navbar={{
        linkStylings: {
          text: {
            textColor:
              'text-black hover:text-emerald-500 dark:text-white dark:hover:text-emerald-500',
          },
        },

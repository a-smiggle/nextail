    ...
    <Layout>
      <div className="relative h-full w-full p-4">
        <div className="h-full rounded-xl bg-white p-4 dark:bg-slate-600">
          <h1 className="font-bold">Navbars</h1>
          <div className="p-4">
            <Tabs
              mainStylings={{
                border: {
              ...
              data={[
                {
                  ...
                  content: (
                    <div className="p-4">
                      <h2>Navbars</h2>
                      <p>
                        Navbars are essential parts of many websites. There are
                        found at the top of a website and have key components
                        like links to other pages.
                      </p>

                      <h3 className="pt-4">Navbar V1 (Navbar)</h3>
                      <p>
                        Allows branding, links and buttons to be displayed. Pass
                        open and toggle props to enable mobile menu.
                      </p>
...
/>`}
                      ...
                      <h3 className="pt-4">Navbar V1 - Customised</h3>
                      <p>Example of customised Navbar V1.</p>
                      <div className="md:w-3/4">
                        <Tabs
                          mainStylings={{
                            border: { borderWidth: ' ' },
                                  ...
                                  <div className="rounded md:w-3/4">
                                    <NavbarV1
                                      ...
                                      linkStylings={{
                                        text: {
                                          textColor:
                                            'text-emerald-900 hover:text-white',
                                        },
                                        ...
                                        buttons: (
                                          <div className="flex gap-2">
                                            <a
                                              href="https://github.com/a-smiggle/nextail"
                                              target="_blink"
                                              className="text-white transition-colors duration-300 hover:text-black dark:hover:text-black"
                                            >
                                              <svg
                                                viewBox="0 0 30 30"
                                                className="h-10 w-10 fill-current"
...
/>`}
                      ...
                      <h3 className="pt-4">Navbar V2 (NavbarSimple)</h3>
                      <p>
                        A simple Navbar that is useful on mobile devices that
                        can toggle a sidebar.
                      </p>
                      <div className="md:w-3/4">
                        <Tabs
                          mainStylings={{
...
/>`}
                      ...
                      <h3 className="pt-4">Navbar V2 - Customised</h3>
                      <p>Customised example of Navbar V2.</p>
                      <div className="md:w-3/4">
                        <Tabs
                          mainStylings={{
                            border: { borderWidth: ' ' },
                ...
                },
                {
                  ...
                  content: (
                    <div className="p-4">
                      ...
                      <CodeSnippet
                        data={`import { Navbar, NavbarV1, NavbarV2, NavbarSimple} from '@nextail/core/Navbar';
//or
import { Navbar, NavbarV1, NavbarV2, NavbarSimple} from '@nextail/core';`}
                      />
                    </div>
                  ),
                },
                      ...
                      data={[
                        {
                          ...
                          content: (
                            <>
                              <h2 className="py-4">NavbarProps</h2>
                        ...
                        },
                        {
                          ...
                          content: (
                            <>
                              <h2 className="py-4">NavbarData</h2>
                              <div className="w-full overflow-auto">
                                <TableSimple
                                  titleStylings={{
                                    border: {
